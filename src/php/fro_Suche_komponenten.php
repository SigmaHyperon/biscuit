...
<form action="fro_Suche_komponenten.php" method="post">
        <table class="suche">
            ...
            <tr>
                <td> <input type="text" name="txt_Suche_komponenten" size="30"/><td><input type="submit" name="action" value="Suchen"/></td><td colspan="2" align="right"> <input type="reset" value="Verwerfen" /></td>
            </tr>            
        </table>        
</form>